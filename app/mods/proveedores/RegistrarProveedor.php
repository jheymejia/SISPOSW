...
<input type="text" name="sdfds" id="" maxlength="5" required>  
</form>
-->
    ...
    <div class="d-flex justify-content-center ">
        <form action="RegProv.php" method="post" >
            <div class="form-group">
              ...
              <div name='Ciudades' class='btn-block' id='Ciudades'></div>
                 <br>
            ...
            <input type="submit" class="btn btn-primary btn-block" name="Enviar" value="Registrar" onclick="return confirm('Registrar este Proveedor?')">
