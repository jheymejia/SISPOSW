...
<body>
    ...
    <h1 class="text-center" style="color:red; background-color:blue"> Borrar Proveedor</h1>
    <br>
            ...
            <div class="form-group">
                ...
                <div id="datos" style="display:none">
                    ...
                    <select v-model="departamento" id="departamento" class="btn-block">
                        ...
                        <button type="button" v-on:click="eliminar()" class="btn btn-primary btn-block"
                            onclick="return confirm('Borrar este Proveedor?')">Borrar
                            Proveedor"</button>
    ...
    methods: {
        cargarDatos: function() {
            ...
            axios({
                ...
                url: 'elimProv.php', //Archivo donde se enviara el formulario
                data: formulario
        ...
        eliminar: function() {
            const formulario = new FormData();
            formulario.set('operacion', "eliminar");
